...
if [ -f "H:\14 programy\Unreal Engine\UE_4.15\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "H:\14 programy\Unreal Engine\UE_4.15\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
